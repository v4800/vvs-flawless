...
return [
    'links' => [
        ...
        'description' => 'Comprendre la différence avant de choisir une montre iced-out.',
    ...
    'diamond_vs_moissanite' => [
        ...
        'comparison_intro' => 'Voici les différences les plus utiles à connaître avant de choisir.',
        'columns' => [
            'criterion' => 'Critère',
            'diamond' => 'Diamant',
        ...
        'rows' => [
            [
                ...
                'moissanite' => 'La moissanite utilisée en joaillerie est du carbure de silicium créé en laboratoire.',
            ],
            [
                'label' => 'Éclat',
                'diamond' => 'Éclat caractéristique du diamant, influencé notamment par la qualité de taille.',
                'moissanite' => 'Très brillante, avec davantage de feux colorés que le diamant selon le GIA.',
            ],
            [
                'label' => 'Dureté',
                'diamond' => 'Le diamant est la pierre la plus dure sur l’échelle de Mohs.',
            ...
            [
                'label' => 'Budget',
                'diamond' => 'Le coût dépend fortement du type de diamant, du poids et de la qualité.',
        ...
        'choice_diamond_title' => 'Choisir le diamant',
        'choice_diamond_text' => 'Choisissez le diamant si le fait de posséder du diamant est lui-même un critère essentiel pour vous. Il faut alors vérifier précisément le type de diamant, la qualité annoncée et les preuves fournies par le vendeur.',
        'choice_moissanite_title' => 'Choisir la moissanite',
        'choice_moissanite_text' => 'Choisissez la moissanite si vous recherchez surtout beaucoup d’éclat et un pavage iced-out tout en gardant un budget plus accessible. La pierre doit néanmoins être annoncée clairement comme moissanite.',
        'cta_title' => 'Voir les montres moissanite VVS',
        'cta_text' => 'Découvrez les modèles VVS FLAWLESS disponibles sur réservation en Belgique, avec le prix et le mouvement affichés avant votre demande.',
        'cta_label' => 'Voir la collection',
        'sources_title' => 'Sources gemmologiques',
        'sources_intro' => 'Les différences techniques présentées dans ce guide s’appuient sur les ressources du Gemological Institute of America (GIA).',
        'sources' => [
            [
                'label' => 'GIA — Diamond',
