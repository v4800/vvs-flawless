...
const seoGuides = computed(() => [
    { href: localizedRoutes.diamondGuide, label: translations.seo_hub.diamond },
    { href: localizedRoutes.vvsGuide, label: translations.seo_hub.vvs },
    {
        href: localizedRoutes.menWomenGuide,
        label: translations.seo_hub.men_women,
    },
    { href: localizedRoutes.belgiumGuide, label: translations.seo_hub.belgium },
]);
...
const mountModelViewer = async () => {
    try {
        ...
        viewer.addEventListener('progress', (event) => {
            modelProgress.value = Math.round(
...
const requestModelViewer = () => {
    if (modelRequested.value || modelLoaded.value) return;
...
<template>
    ...
    <div class="min-h-screen bg-black text-white">
        ...
        >
            ...
            >
                <Link :href="localizedRoutes.watches" class="group flex flex-col">
                    <span
        ...
        <main id="main-content" tabindex="-1">
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                <div
                                    class="rounded-xl border border-white/10 bg-black/70 px-6 py-4 text-center"
                                >
                            ...
                            <div
                                v-if="modelError"
                                class="absolute inset-0 z-20 flex items-center justify-center text-red-300"
                            >
                            ...
                            <div
                                v-if="modelLoaded"
                                class="pointer-events-none absolute bottom-3 left-1/2 z-30 -translate-x-1/2 rounded-full border border-white/10 bg-black/60 px-4 py-2 text-[9px] font-bold tracking-[0.18em] whitespace-nowrap text-zinc-400 uppercase"
                            >
                ...
                <div class="mx-auto max-w-[1500px]">
                    ...
                    <div class="grid gap-6 sm:grid-cols-2 xl:grid-cols-3">
                        <article
                            ...
                            :key="watch.id"
                            class="watch-card reveal-on-scroll vvs-luxury-card group overflow-hidden rounded-2xl border"
                        >
                            <div class="relative h-[390px] overflow-hidden bg-zinc-950">
                                <img
                                    v-if="watch.image"
                                    :src="watch.image"
                                    :alt="watch.name"
                            ...
                            <div class="p-6">
                                <h3
                                    class="vvs-display-title min-h-[58px] text-center text-2xl text-white"
                                >
                                    {{ watch.name }}
                                </h3>
                                <p
                                ...
                                <div class="mt-6 grid grid-cols-2 gap-3">
                                    <Link
                                        ...
                                        class="vvs-choice-card rounded-xl border p-4"
                                    >
                                        <p class="text-[9px] text-zinc-500 uppercase">
                                ...
                                <Link
                                    ...
                                    class="vvs-button-secondary mt-6 flex w-full items-center justify-center rounded-xl px-4 py-4 text-xs font-bold uppercase"
                                >
                                    {{ translations.collection.view_watch }} →
                                </Link>
                            </div>
            ...
            <section id="concept" class="scroll-mt-24 px-5 pb-8 sm:px-6 lg:px-10">
                <div
                    class="reveal-on-scroll vvs-luxury-card mx-auto max-w-[1500px] rounded-2xl border p-8 md:p-10"
                >
                    ...
                    <button
                        ...
                        class="vvs-button-primary mt-6 rounded-xl px-6 py-4 text-xs font-bold uppercase"
                    >
