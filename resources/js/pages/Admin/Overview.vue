...
<template>
    ...
    >
        <section class="grid gap-4 sm:grid-cols-2 xl:grid-cols-5">
            <article class="rounded-2xl border border-white/10 bg-zinc-950 p-5">
            ...
            <article class="rounded-2xl border border-white/10 bg-zinc-950 p-5">
                <p class="text-xs font-bold text-zinc-500">Ventes terminées</p>
                <p class="mt-3 text-3xl font-black">
                    {{ stats.completed }}
                </p>
            </article>
                    ...
                    <table class="w-full min-w-[760px] text-left text-sm">
                        ...
                        <tbody class="divide-y divide-white/5">
                            ...
                            >
                                ...
                                <td
                                    class="max-w-56 truncate px-5 py-4 text-zinc-300"
                                >
