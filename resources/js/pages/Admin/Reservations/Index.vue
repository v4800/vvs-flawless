...
const openEmailComposer = (reservation, reviewInvitation = false) => {
    ...
    emailComposer.reviewInvitation = reviewInvitation;
};

const closeEmailComposer = () => {
    emailComposer.reservation = null;
    emailComposer.reviewInvitation = false;
};
...
<template>
    ...
    >
            ...
            >
                <div class="grid md:grid-cols-[150px_1fr]">
                    ...
                    <div class="min-w-0 p-4 sm:p-5">
                        ...
                        >
                            <ReservationContactActions
                                :reservation="reservation"
                                @compose-email="
                                    openEmailComposer(reservation, $event)
                                "
                            />
                            <span
                    ...
                    <div class="grid gap-6 xl:grid-cols-[1.25fr_0.75fr]">
                        ...
                        >
                            ...
                            <label class="text-xs text-zinc-400">
                                ...
                                <input
                                    v-model="draftFor(reservation).travel_fee"
                                    type="number"
                                    min="0"
                                    step="0.01"
                                    class="mt-2 w-full rounded-xl border border-white/10 bg-black px-3 py-2.5 text-white"
                            ...
                            <label class="text-xs text-zinc-400 sm:col-span-2">
                                ...
                                <input
                                    v-model="
                                        draftFor(reservation).handover_address
                                    "
                                    type="text"
                                    maxlength="500"
                                    class="mt-2 w-full rounded-xl border border-white/10 bg-black px-3 py-2.5 text-white"
                            ...
                            <label class="text-xs text-zinc-400 sm:col-span-2">
                                ...
                                <textarea
                                    v-model="draftFor(reservation).admin_notes"
                                    rows="4"
                                    maxlength="10000"
                                    class="mt-2 w-full rounded-xl border border-white/10 bg-black px-3 py-2.5 text-white"
                            ...
                            >
                                Vérifie les champs : certaines informations ne
                                sont pas valides.
                            </div>
                        ...
                        <aside class="space-y-4">
                            ...
                            >
                                ...
                                <ol
                                    v-if="reservation.status_histories.length"
                                ...
                                <p v-else class="mt-3 text-xs text-zinc-600">
                                    Aucun changement enregistré depuis la mise à
                                    niveau.
                                </p>
                            </div>
                        </aside>
        ...
        <ReservationEmailComposer
            ...
            :key="
                emailComposer.reservation.id +
                '-' +
                Number(emailComposer.reviewInvitation)
            "
            :reservation="emailComposer.reservation"
