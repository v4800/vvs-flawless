...
const openEmailComposer = (reservation, reviewInvitation = false) => {
    const reviewUrl = window.location.origin + '/#avis-clients';

    emailComposer.reservation = reservation;
    emailComposer.subject = reviewInvitation
        ? 'Votre avis sur votre expérience VVS FLAWLESS'
        : 'Votre réservation ' +
          reservation.reservation_number +
          ' — VVS FLAWLESS';
    emailComposer.message = reviewInvitation
        ...
        : 'Je vous contacte au sujet de votre réservation ' +
          reservation.reservation_number +
          '.';
    emailComposer.errors = {};
};

const closeEmailComposer = () => {
    if (emailComposer.sending) {
        return;
    }

    emailComposer.reservation = null;
...
const sendReservationEmail = () => {
    const reservation = emailComposer.reservation;

    if (!reservation) {
        return;
    }

    emailComposer.sending = true;
    emailComposer.errors = {};

    router.post(
        '/admin/reservations/' + reservation.id + '/email',
        {
                ...
                >
                    <label class="xl:col-span-2">
                        ...
                        <input
                            ...
                            class="w-full rounded-xl border border-white/10 bg-black px-4 py-3 text-sm transition outline-none placeholder:text-zinc-600 focus:border-amber-300/60"
                        />
                    </label>
                        ...
                        <div class="min-w-0 p-4 sm:p-5">
                            ...
                            >
                                ...
                                <button
                                    type="button"
                                    class="rounded-lg bg-white/5 px-3 py-2 text-xs font-bold hover:bg-white/10"
                                    @click="openEmailComposer(reservation)"
                                >
                                    Envoyer un email
                                </button>
                                <button
                                ...
                                <button
                                    ...
                                    @click="
                                        openEmailComposer(reservation, true)
                                    "
                                >
                            ...
                            >
                                ...
                                <div class="flex flex-wrap gap-2 sm:col-span-2">
                                    ...
                                    <button
                                        ...
                                        @click="archiveReservation(reservation)"
                                    >
                                        {{
                            ...
                            <aside class="space-y-4">
                                ...
                                >
                                    ...
                                    <p
                                        ...
                                        class="mt-2 text-xs break-all text-zinc-500"
                                    >
        ...
        >
            ...
            >
                <div class="flex items-start justify-between gap-4">
                    <div>
                        ...
                        <p class="mt-2 text-sm text-zinc-400">
                            À {{ emailComposer.reservation.email }}
                        </p>
                    </div>
                    <button
                        type="button"
                ...
                <form
                    ...
                    @submit.prevent="sendReservationEmail"
                >
                    <label class="block">
                        ...
                        <input
                            v-model.trim="emailComposer.subject"
                            type="text"
                            maxlength="150"
                            required
                        ...
                        />
                        <span
                            v-if="emailComposer.errors.subject"
                            class="mt-1 block text-xs text-red-300"
                        >
                            {{ emailComposer.errors.subject }}
                        </span>
                    </label>
                    ...
                    <label class="block">
                        ...
                        <textarea
                            v-model.trim="emailComposer.message"
                            rows="8"
                            maxlength="5000"
                            required
                        ...
                        ></textarea>
                        <span
                            v-if="emailComposer.errors.message"
                            class="mt-1 block text-xs text-red-300"
                        >
                            {{ emailComposer.errors.message }}
                        </span>
                    </label>

                    <p
                        v-if="emailComposer.errors.email_message"
                        class="rounded-xl border border-red-400/20 bg-red-400/10 px-4 py-3 text-sm text-red-200"
                    >
                        {{ emailComposer.errors.email_message }}
                    </p>
